...
namespace mediklaud_api.Interface.Pharmacy.Entry
{
    ...
    {
        Task<string> GetConfigaration(CommonGID_CID_For_PurReqOrd commonGID_CID_For_PurReqOrd);
        ...
        Task<string> GetItemList(PurReqOrderItemList purReqOrderItemList);
        Task<string> GetRequisitionList(PurReqOrderRequsitionNo purReqOrderRequsitionNo);
    }
}
